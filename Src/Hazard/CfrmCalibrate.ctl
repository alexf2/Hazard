...
Begin VB.UserControl CfrmCalibrate 
   ...
   Begin Threed.SSFrame ssfrmParams 
      ...
      Begin VB.Label Label1 
         AutoSize        =   -1  'True
         Caption         =   "1) Вероятность нарушения равновесия"
         ForeColor       =   &H00000000&
         Height          =   390
         Left            =   195
         TabIndex        =   19
      ...
      Begin VB.Label Label2 
         AutoSize        =   -1  'True
         Caption         =   "2) Вероятность опасной ситуации"
         ForeColor       =   &H00000000&
         Height          =   390
         Left            =   195
         TabIndex        =   18
      ...
      Begin VB.Label Label3 
         AutoSize        =   -1  'True
         Caption         =   "3) Вероятность критической ситуации"
         ForeColor       =   &H00000000&
         Height          =   390
         Left            =   2415
         TabIndex        =   17
      ...
      Begin VB.Label Label4 
         AutoSize        =   -1  'True
         Caption         =   "4) Вероятность происшествия"
         ForeColor       =   &H000000FF&
         Height          =   390
         Left            =   2415
         TabIndex        =   16
